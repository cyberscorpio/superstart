...
REM create xpi
: createxpi
call 7z.exe a superstart.xpi * -r -tzip -x!*.bat -x!*.tmp -x!*.swp -x!*.svn -x!*.zip -x!*.git -x!*.php -x!tags -x!' -x!` -x!*.xpi -x!*.pdn -x!*.idl -x!*.patch -x!chrome/*
...
REM create JAR
: createjar
call 7z.exe a superstart.jar * -r -tzip -mx0 -x!*.bat -x!*.tmp -x!*.swp -x!*.svn -x!*.zip -x!*.git -x!*.php -x!tags -x!' -x!` -x!*.xpi -x!*.pdn -x!*.idl -x!*.patch -x!test*
cd ..
